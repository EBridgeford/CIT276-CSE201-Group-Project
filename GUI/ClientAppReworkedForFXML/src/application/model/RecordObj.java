...
public class RecordObj{
     ...
     */
     ...
     private void setCampus(String str){this.campus = new SimpleStringProperty(str);}                         
     ...
     */
     ...
     private void setBldg(String str){this.bldg = new SimpleStringProperty(str);}                        
     ...
     */
     ...
     private void setRm(String str){this.rm = new SimpleStringProperty(str);}                            

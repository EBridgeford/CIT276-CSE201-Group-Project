...
public class RootLayout {
	...
	private void openFile(File file) {
		...
		if(fileName.trim().toUpperCase().startsWith("INV")) {
			...
			presentationInventoryData = test.Parse(file, fileType);

		}
		else if(fileName.toUpperCase().startsWith("INI")) {

			fileType = FileType.INITIAL;
			presentationInitialData = test.Parse(file, fileType);
			System.out.println(presentationInitialData);
...
//
//				currentRecord.setTimeStamp(newCellValue);
//
//			}
...
//			else if(event.getSource() == lastScannedOn) {
//
//				currentRecord.setTimeStamp(null);
//				currentRecord.setTimeStamp(oldCellValue);
//
//			}
//			else if(event.getSource() == lastScannedBy) {
//

...
import application.model.LocationObj;
...
public class LocationObservableListBuilder{
     ...
     */
    public ObservableList<CampusObj> getCampusList(){return campuses;}
    
    /**
     * This method returns the observable list of BLDGObjs.
     * @return ObservableList
     */
    public ObservableList<BLDGObj> getBLDGList(){return bldgs;}
    
    /**
     * This method returns the observable list of RoomObjs.
     * @return ObservableList
     */
    public ObservableList<RoomObj> getRMList(){return rooms;}
